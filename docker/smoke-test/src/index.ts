...
async function waitForService(url: string, name: string, maxAttempts = 30): Promise<boolean> {
...
async function testCoordinatorHealth(): Promise<TestResult> {
  ...
  try {
    ...
    if (response.ok) {
      return { name: "coordinator-health", passed: true, duration: Date.now() - start };
    }
    return { name: "coordinator-health", passed: false, error: `Status: ${response.status}`, duration: Date.now() - start };
  } catch (error) {
    return { name: "coordinator-health", passed: false, error: String(error), duration: Date.now() - start };
  }
}
...
async function testBeaconHealth(): Promise<TestResult> {
  ...
  try {
    ...
    if (response.ok) {
      return { name: "beacon-health", passed: true, duration: Date.now() - start };
    }
    return { name: "beacon-health", passed: false, error: `Status: ${response.status}`, duration: Date.now() - start };
  } catch (error) {
    return { name: "beacon-health", passed: false, error: String(error), duration: Date.now() - start };
  }
}
...
async function testEchoLlmHealth(): Promise<TestResult> {
  ...
  try {
    ...
    if (response.ok) {
      return { name: "echo-llm-health", passed: true, duration: Date.now() - start };
    }
    return { name: "echo-llm-health", passed: false, error: `Status: ${response.status}`, duration: Date.now() - start };
  } catch (error) {
    return { name: "echo-llm-health", passed: false, error: String(error), duration: Date.now() - start };
  }
}
...
async function testEchoLlmChat(): Promise<TestResult> {
  ...
  try {
    ...
    if (!response.ok) {
      return { name: "echo-llm-chat", passed: false, error: `Status: ${response.status}`, duration: Date.now() - start };
    }

    const data = await response.json();
    if (data.choices && data.choices[0]?.message?.content) {
      return { name: "echo-llm-chat", passed: true, duration: Date.now() - start };
    }
    return { name: "echo-llm-chat", passed: false, error: "Invalid response format", duration: Date.now() - start };
  } catch (error) {
    return { name: "echo-llm-chat", passed: false, error: String(error), duration: Date.now() - start };
  }
}
...
async function testBeaconRegistration(): Promise<TestResult> {
  ...
  try {
    ...
    if (response.ok || response.status === 201) {
      return { name: "beacon-registration", passed: true, duration: Date.now() - start };
    }
    return { name: "beacon-registration", passed: false, error: `Status: ${response.status}`, duration: Date.now() - start };
  } catch (error) {
    return { name: "beacon-registration", passed: false, error: String(error), duration: Date.now() - start };
  }
}
...
async function testBeaconMemoryStore(): Promise<TestResult> {
  ...
  try {
    ...
    if (retrieved.value?.message === testValue.message) {
      return { name: "beacon-memory-store", passed: true, duration: Date.now() - start };
    }
    return { name: "beacon-memory-store", passed: false, error: "Value mismatch", duration: Date.now() - start };
  } catch (error) {
    return { name: "beacon-memory-store", passed: false, error: String(error), duration: Date.now() - start };
  }
}
