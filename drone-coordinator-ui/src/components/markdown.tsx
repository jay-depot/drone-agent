...
/**
 * Shared markdown renderer for all UI surfaces (wiki pages, session chat).
 * Wiki-specific preprocessing (frontmatter collapse, wikilink rewriting)
 * lives in WikiMarkdown, which wraps this component.
 */
