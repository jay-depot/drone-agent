...
- app.tsx: dropped local PREVIEW_MAX/preview (import from format.ts), removed formatDiffResult import + git\_\_diff special-case, single clearTail() on error (removed 3x redundant), markdown kind for assistant.
