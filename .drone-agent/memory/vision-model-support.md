...
- `drone-agent/src/plugins/file.ts` — file__read_image tool
...
## Remaining
- Step 14 (tests) was not implemented — new tests for file__read_image, provider adapters with images, etc. still need to be written