...
export async function registerRoutes(app: FastifyInstance) {
  ...
  app.post<{ Body: RegisterBeaconRequest }>("/beacons", async (request, reply) => {
  ...
  app.post<{ Params: { id: string } }>("/beacons/:id/heartbeat", async (request, reply) => {
  ...
  app.delete<{ Params: { id: string } }>("/beacons/:id", async (request, reply) => {
