...
**Turn**:
A single action within a round, whether it is a user message turn, a pending message turn, an agent response with tool call turn, or a tool result turn. See: **Round** above.
